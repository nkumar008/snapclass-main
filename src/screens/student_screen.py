...
def student_dashboard():
    ...
    with st.spinner('loading your enrolled subjcts...'):
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_button():
           if st.button('Unenroll from this course', type='tertiary',width='stretch',icon=':material/delete_forever:'):
               ...
               st.toast("Unenrolled from {sub['name']}succesfully!")
               st.rerun()
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name=st.text_input("Enter your name",placeholder='E.g. Niraj kumar')
            
            st.subheader('Optional: Voice Enrollment')
            st.info("Enroll you for voice only attandance")
            
            audio_data=None
            try:
                audio_data=st.audio_input('Record a short phrase like I am present, My name is Rajkumar.')
            except Exception:
