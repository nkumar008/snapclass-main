...
from src.database.db import check_teacher_exixts,create_teacher,teacher_login,get_teacher_subjects,get_attendance_for_teacher
...
def teacher_dashboard():
    ...
    with tab1:
        ...
        if st.button('Take Attandance',type=type1, width='stretch',icon=':material/ar_on_you:'):
            st.session_state.current_teacher_tab='take_attendance'
            st.rerun()
    with tab2:
    ...
    with tab3:
        ...
        if st.button('Attandance records',type=type3, width='stretch',icon=':material/cards_stack:'):
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter username",placeholder='nirajkumar') 
    ...
    with btnc1:
        if st.button('login', icon=':material/passkey:', shortcut='control+enter',width='stretch'):
            if login_teacher(teacher_username,teacher_password):
                ...
                st.error("Invalid username and passwod")
...
def register_teacher(teacher_username,teacher_name,teacher_password,teacher_password_confirm):
    ...
    if check_teacher_exixts(teacher_username):
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username",placeholder='nirajkumar') 
    teacher_name=st.text_input('Enter your name',placeholder='Niraj kumar')
